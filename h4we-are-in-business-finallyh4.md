...
<img src="https://raw.githubusercontent.com/i90rr/i90rr.github.io/master/resources/img/394089_ds.png" alt="A cold but sunny Saturday morning at the oceanside" title="A cold but sunny Saturday morning at the oceanside" align="right" width="300" height="300" style="margin-left: 17px" vspace="1px">
...
I'm a happy user of [Fedora](https://getfedora.org) & [CentOS](https://www.centos.org) since mid 2014; previously I ran [Arch Linux](https://wiki.archlinux.org/index.php/Arch_Linux#Principles) after trying Ubuntu, Debian, Slackware, Gentoo/Funtoo and FreeBSD.
<br>My everyday toolkit consists of [tmux](https://tmux.github.io) + [tmux-plugins](https://github.com/tmux-plugins) + [tmuxinator](https://github.com/tmuxinator/tmuxinator), [fish](http://fishshell.com) + [omf](https://github.com/oh-my-fish/oh-my-fish) + [autojump](https://github.com/wting/autojump) and [Spacemacs](http://spacemacs.org), an [Emacs](https://xkcd.com/378) distribution that simply rocks (thanks E1HC!).
<br>Among the GUI toolset there is FF + [DDG](https://www.duckduckgo.com), [Telegram](https://desktop.telegram.com), [KeePass](https://keepass.info) and [Lollypop](https://gnumdk.github.io/lollypop-web/) for playing music.</br>
You can usually find me on [IRC](https://www.weechat.org) (Freenode, OFTC, others...), [Direct Connect](https://www.apexdc.net), [SoulSeek](http://www.slsknet.org/news) and [pwn+](http://www.pwnconf.org)

I love to surf. [Surfing](http://www.surfertoday.com/surfing/8267-the-best-surfing-quotes-of-all-time) is a [state of mind](https://www.youtube.com/watch?v=ACMckXr1j4o) - surfing is Zen in movement.</br>
