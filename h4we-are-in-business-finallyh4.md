...
I'm a happy user of [Fedora](https://getfedora.org) & [CentOS](https://www.centos.org) since mid 2014; previously I ran [Arch Linux](https://wiki.archlinux.org/index.php/Arch_Linux#Principles) after trying Ubuntu, Debian, Slackware, Gentoo/Funtoo and FreeBSD. My everyday toolkit consists of [tmux](https://tmux.github.io) + [tmuxinator](https://github.com/tmuxinator/tmuxinator), [fish](http://fishshell.com) + [omf](https://github.com/oh-my-fish/oh-my-fish) + [autojump](https://github.com/wting/autojump) and [Spacemacs](http://spacemacs.org), an [Emacs](https://xkcd.com/378)-based editor that rocks (thanks E1NS!). Among the GUI toolset there is FF + [DDG](https://www.duckduckgo.com), [Telegram](https://desktop.telegram.com) and [KeePass](https://keepass.info).</br>
You can usually find me on IRC (Freenode, OFTC, others...) and [pwn+](http://www.pwnconf.org)
