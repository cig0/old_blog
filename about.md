...
* Is written using the versatile [GNU Emacs](https://www.gnu.org/software/emacs/), an extensible operating system often used as just a text editor
...
I also like to code my own tools for which I mostly use Python although I'm more on the side of Go, Rust and lately Swift. Lisp and Haskell draw my attention too...
